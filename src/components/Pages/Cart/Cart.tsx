...
const Cart = () => {
  ...
  const priceWord = productForOrder.length > 1 ? "items" : "item";
        ...
        <article className={styles.container}>
          ...
          <div className={styles.total}>
            <div className={styles.total__item}>
              ...
              <p
                className={clsx(styles.total__count, styles.total__count_value)}
              >
            ...
            <div className={clsx(styles.total__item, styles.total__item_style)}>
              ...
              <p
                className={clsx(
                  styles.total__brutto,
                  styles.total__brutto_value
                )}
              >
                700&#36;
              </p>
            ...
            <div className={styles.total__item}>
              ...
              <p
                className={clsx(styles.total__netto, styles.total__netto_value)}
              >
                590&#36;
              </p>
            </div>
